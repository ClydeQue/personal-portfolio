// One catalog drives the complete Professional list and Personal icon groups.
export const professionalTechGroups = [
  { title: 'Languages & frontend', items: ['C#', 'TypeScript', 'JavaScript', 'Java', 'Python', 'SQL', 'Shell', 'HTML', 'CSS', 'React', 'Next.js', 'Tailwind CSS', 'MUI', 'TanStack Query'] },
