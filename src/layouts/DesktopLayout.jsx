              ...
              <div ref={contactInfoRef} className="space-y-8 flex flex-col items-start w-full max-w-md lg:max-w-none lg:justify-self-end">
                ...
                <div className="contact-info-item space-y-3 text-left">
                  ...
                  <div className="space-y-2">
                    ...
                    <a href="https://wa.me/639690919791" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white font-[gotham] hover:text-[#25D366] transition-colors">
                ...
                <div className="contact-info-item space-y-3 text-left">
                  ...
                  <p className="text-white/70 font-[gotham] text-sm leading-relaxed">
                    Feel free to reach out for business inquiries, project collaborations, or any questions. I'm always open to new opportunities!
                  </p>
                </div>
                ...
                <div className="contact-info-item space-y-3 text-left">
                  ...
                  <div className="flex flex-wrap justify-start gap-4">
                    ...
                    <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-white font-[gotham] hover:text-[#7BB3D3] transition-colors flex items-center gap-2">
                      <img src="/icons/twitter.svg" alt="Twitter" className="w-5 h-5 brightness-0 invert" />
